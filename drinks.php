...
<?php require_once('template/header.php'); ?>
	...
	<div class="nav1">
			<ul>
				...
				<li>|</li>
				<li><a href="drinks.php" class="active" style="color:#111;">Drinks</a></li>
				<li>|</li>
		...
		<div id="content">
				...
				<div id="product">
					...
					<?php
						...
						$query = $conn->query("SELECT * FROM product LEFT JOIN stock ON product.productid=stock.productid WHERE category='Drinks' AND productstatus='On sale' AND stock.quantity>0 ORDER BY brand, name") or die (mysqli_error());
