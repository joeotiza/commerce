					...
					<div class="modal-body">
						...
						<center>
							<table>
								...
								<tr>
									<td><input type="hidden" name="category" value="Clothing"></td>
								</tr>
							</table>
						</center>
					</div>
			...
			<?php
				if (isset($_POST['add']))
					...
					<div id="rightcontent" style="position:absolute; top:10%;">
								<div class="alert alert-info"><center><h2>Clothing</h2></center></div>
								<br />
								...
								<table class="table table-hover" style="background-color:;">
									...
									<?php
										...
										$query = $conn->query("SELECT * FROM `product` WHERE category='Clothing' AND productstatus='On sale' ORDER BY `name`") or die(mysqli_error());
