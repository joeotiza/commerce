		...
		<div id="content">
				...
				<div id="product">
					...
					<?php
						...
						$query = $conn->query("SELECT * FROM product LEFT JOIN stock ON product.productid=stock.productid WHERE category='Stationery' AND productstatus='On sale' AND stock.quantity>0 ORDER BY brand, name") or die (mysqli_error());
