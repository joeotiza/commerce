...
<div id="content">
	...
	<div class="nav1">
			<ul>
				<li><a href="product.php" class="active" style="color:#111;">Electronics</a></li>
				<li>|</li>
		...
		<div id="content">
				...
				<div id="product">
					...
					<?php
						...
						$query = $conn->query("SELECT *FROM product WHERE category='Electronics' ORDER BY productid DESC") or die (mysqli_error());
