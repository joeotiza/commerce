...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2021 at 01:18 PM
...
(5, 1, 60000, '2021-11-26', 'Confirmed'),
(88, 2, 2600, '2021-11-26', 'Confirmed'),
(674, 3, 126700, '2021-11-26', 'Confirmed');
...
--
ALTER TABLE `transaction`
  MODIFY `transactionid` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=675;
